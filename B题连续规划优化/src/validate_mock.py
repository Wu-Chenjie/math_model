...
def main():
    p=argparse.ArgumentParser();p.add_argument('--count',type=int,default=30);p.add_argument('--early',type=float,default=35);p.add_argument('--planner-depth',type=int,choices=[0,1,2,3],default=2);p.add_argument('--strategy',choices=['joint','previous','stage1','stage2','baseline'],default='joint')
    a=p.parse_args();rows=[]
    for problem in [3,4]:
