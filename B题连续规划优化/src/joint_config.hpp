...
#define B_SHORTCUT_CONFIG 1
inline Options joint_configuration(int method,int problem){
 if(method==78){auto o=joint_configuration(56,problem);o.shortcut=true;return o;}
 if(method>=74&&method<=77){auto o=joint_configuration(56,problem);if(problem==4)o.optical_portfolio=method-73;return o;}
 if(method>=70&&method<=73){auto o=joint_configuration(56,problem);o.bearing_bin=method==70?4:method==71?3:method==72?6:8;return o;}
 if(method>=67&&method<=69){auto o=joint_configuration(56,problem);o.refinement=method==69?2:1;if(method==68&&problem==3)o.planning_samples=63;return o;}
 if(method==66){auto o=joint_configuration(56,problem);o.budget_aware=true;return o;}
 if(method>=61&&method<=65){auto o=joint_configuration(method==61||method==63?56:60,problem);if(problem==4)o.optical_search=method<=62?1:method<=64?2:3;return o;}
 if(method==60){auto o=joint_configuration(56,problem);if(problem==4)o.variable_optical=true;return o;}
 if(method==58){auto o=joint_configuration(56,problem);if(problem==4)o.terminal_mode=1;return o;}
 if(method==59){auto o=joint_configuration(58,problem);if(problem==4)o.terminal_mode=2;return o;}
