...
按实现还可给出保守总预算。目标域外切多边形的顶点半径为 $R_p=1800\sec(\pi/64)=1802.171$ 米，覆盖网格最大半径为 $R_g=950\sqrt7=2513.464$ 米。第二测点半径不超过 $R_g+\sqrt{750^2+300^2}=3321.239$ 米；精确最小包围圆圆心在凸区域内，横移检测点半径不超过 $R_p+50$；光学外接矩形在任意一组正交轴上的投影均不超过 $R_p$，故其清除点半径不超过 $\sqrt2R_p$。统一向上取3322米覆盖全部动作位置。
...
|问题|平均总时间/秒|总时间P95/秒|平均单源/秒|单源均值95%区间|合并单源/秒|
|:--|:--|:--|:--|:--|:--|
...
|问题|对照|对照均时/秒|主策略节省/秒|配对节省95%区间|均时下降|
|:--|:--|:--|:--|:--|:--|
|3|固定访问顺序|5332.33|860.94|[801.03, 920.86]|16.15%|
|4|固定访问顺序|15034.85|4093.99|[3973.12, 4214.85]|27.23%|
...
|压力设置|问题3全清除|问题4全清除|问题3单源/秒|问题4单源/秒|两问最大总时间/秒|
|:--|:--|:--|:--|:--|:--|
...
以下六条专门标记为**本地HTTP演练**，仅借用题目表1的列含义。

|问题|本地案例标识|清除数|平均时间/秒|桥接运行时间/秒|终止证书|
|:--|:--|:--|:--|:--|:--|
|3|LOCAL-P3-30001|16|299.67|0.20|upper_bound_16|
|3|LOCAL-P3-30002|10|402.38|0.34|seven_point_per_channel|
|3|LOCAL-P3-30003|11|376.70|0.29|seven_point_per_channel|
|4|LOCAL-P4-30001|16|409.61|0.45|upper_bound_16|
|4|LOCAL-P4-30002|10|1259.63|1.26|convex_mesh_per_channel|
|4|LOCAL-P4-30003|11|921.36|0.54|convex_mesh_per_channel|
