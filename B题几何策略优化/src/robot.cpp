...
int main(int argc,char**argv){try{
 ...
 std::string strategy=argc>5?argv[5]:"joint";if(strategy!="geometric"&&strategy!="joint"&&strategy!="previous"&&strategy!="baseline"&&strategy!="stage1"&&strategy!="stage2")throw std::runtime_error("strategy must be geometric, joint, previous, stage1, stage2 or baseline");
 Options o=joint_configuration(strategy=="geometric"?84:strategy=="joint"?78:strategy=="previous"?56:strategy=="stage2"?39:strategy=="stage1"?38:0,prob);if(argc>2)o.early=atof(argv[2]);if(argc>3)o.eta=atof(argv[3]);
