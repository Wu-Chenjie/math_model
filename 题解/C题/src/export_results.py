...
def main():
    data=dict(np.load(ROOT/'artifacts/data.npz'));q1=json.loads((ROOT/'artifacts/q1.json').read_text())
    ...
    notes=[['项目','口径'],['官方原题','https://www.mcm.edu.cn/html_cn/node/27b6e148f8113f09b0269f64a02629fb.html'],
           ...
           ['年度边界','只输出2025年2月1日至12月31日。1月为校准，初始SOC6000，1月储能保持6000；主策略每日回到6000。'],
